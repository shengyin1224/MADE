...
def main(args):
    ...
    fafmodule = FaFModule(model, model, config, optimizer, criterion, args.kd_flag, 
                        ...
                        smooth=True, smooth_sigma=args.smooth_sigma)
    ...
    for cnt, sample in tqdm(enumerate(valloader), total=len(valloader)):
        ...
        result = fafmodule.median_smoothing(data, 1)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--smooth_sigma', type=float, default=0.25, help='sigma of gaussian smoothing')
