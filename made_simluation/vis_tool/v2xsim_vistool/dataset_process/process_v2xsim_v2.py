...
if __name__=="__main__":
    nusc = NuScenes(version='v1.0-mini', dataroot='/GPFS/data/shengyin-1/OpencoodV2-Main/OpenCOODv2/dataset/V2X-Sim-2.0', verbose=True) # specify your own path.
    output_path = "./v2xsim1.0_info" # a folder path. specify your own path.
