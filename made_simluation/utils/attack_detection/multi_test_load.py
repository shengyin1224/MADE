...
RESIDUAL_CALIBRATION_FILE_V2 = "/DB/data/yanghengzhao/adversarial/DAMC/yanghengzhao/disco-net/mreconstruction_loss_validation_v2.npy"

LOAD_DICT_BASE = {
    "residual_ae": "/DB/data/yanghengzhao/adversarial/DAMC/yanghengzhao/disco-net/experiments/residual_ae_v2/",
    "match_cost": "/DB/data/yanghengzhao/adversarial/DAMC/yanghengzhao/disco-net/experiments/match_cost_v2/",
}

class MultiTestDetector(nn.Module):
    def __init__(self, match_cost=True, residual_ae=True, raw_ae=False, residual_ae_v0=False, load_score:Dict={}):
        super().__init__()
        ...
        if match_cost:
            ...
            if "match_cost" in load_score and os.path.exists(os.path.join(load_score['match_cost'], "result.pkl")):
        ...
        if residual_ae:
            ...
            if "residual_ae" in load_score and os.path.exists(os.path.join(load_score['residual_ae'], "result.pkl")):
