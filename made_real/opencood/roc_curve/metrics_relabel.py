...
"""
pgd:
    python opencood/roc_curve/metrics_relabel.py --relabel -t pgd --att_subpath N01_E1e-01_S10
ours:
...
def relabel_pgd(att_subpath):
    with open("/DB/data/yanghengzhao/adversarial/DAMC/yanghengzhao/disco-net/experiments/attack/single/N01_E1e-01_S10/result.pkl", 'rb') as f:
        eval_results1 = pickle.load(f)
    with open("/DB/data/yanghengzhao/adversarial/DAMC/yanghengzhao/disco-net/experiments/gt/single/N01_E1e-01_S10/result.pkl", 'rb') as f:
    ...
    for defense in ["raw_ae", "residual_ae_v2", "match_cost_v2", "multi-test-v3"]:
        with open(f"/DB/data/yanghengzhao/adversarial/DAMC/yanghengzhao/disco-net/experiments/{defense}/{att_subpath}/result.pkl", 'rb') as f:
...
def relabel_ours(att_subpath):
    with open("/DB/data/yanghengzhao/adversarial/DAMC/yanghengzhao/disco-net/experiments/attack/shift_pred/N01_E1e-1_S10_sep/result.pkl", 'rb') as f:
        eval_results1 = pickle.load(f)
    with open("/DB/data/yanghengzhao/adversarial/DAMC/yanghengzhao/disco-net/experiments/gt/shift_pred/N01_E1e-1_S10_sep/result.pkl", 'rb') as f:
        eval_results2 = pickle.load(f)
