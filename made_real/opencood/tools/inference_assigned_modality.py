...
def main():
    ...
    if 'heter' in hypes:
        ...
        assert len(hypes['heter']['ego_modality']) == 2

        opt.note += '_assigned_modality' + f"_ego_{ego_modality}"
    ...
    for i, batch_data in enumerate(data_loader):
        ...
        if batch_data is None:
            continue
        if hypes['fusion']['core_method'] == 'intermediateheter' and hypes['heter']['ego_modality'] != batch_data['ego']['agent_modality_list'][0]:
            continue
        if hypes['fusion']['core_method'] == 'lateheter' and hypes['heter']['ego_modality'] != batch_data['ego']['modality_name']:
