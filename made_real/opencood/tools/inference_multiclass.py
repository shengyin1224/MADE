...
def test_parser():
    ...
    parser.add_argument('--model_dir', type=str, required=False, default='/remote-home/gjliu/OpenCOODv2/opencood/logs_HEAL/v2xverse_point_pillar_lidar_when2comm_2023_09_19_15_39_19', # /remote-home/gjliu/OpenCOODv2/opencood/logs/configfor_debug  /remote-home/gjliu/OpenCOODv2/opencood/logs_HEAL/v2xverse_point_pillar_lidar_v2xvit_2023_09_19_15_33_32
                        help='Continued training path')
    parser.add_argument('--fusion_method', type=str,
                        default='intermediate',
                        help='no, no_w_uncertainty, late, early or intermediate')
    parser.add_argument('--save_vis_interval', type=int, default=2,
...
def main():
    ...
    _, ap50, ap70 = eval_utils.eval_final_results_multiclass(result_stat,
