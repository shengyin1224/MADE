...
class HeterPointPillarsLiftSplatLate(nn.Module):
    def __init__(self, args):
        super(HeterPointPillarsLiftSplatLate, self).__init__()
    ...
    def forward(self, data_dict):
        if 'image_inputs' in data_dict:
            ...
            lidar_feature_2d = self.shrink_lidar(lidar_feature_2d) # H0//2, W0//2
