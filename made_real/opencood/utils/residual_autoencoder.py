...
import sys
sys.path.append("/GPFS/data/shengyin/OpenCOOD-main/opencood/ae_unet")
from src.models import UNet
sys.path.pop()

RESIDUAL_AE_V2 = "/GPFS/data/shengyin/OpenCOOD-main/opencood/ae_unet/autoencoder_0313.pth"
...
class ResidualAutoEncoderV2ReconstructionLoss(nn.Module):
    def __init__(self, checkpoint_path=RESIDUAL_AE_V2):
        super().__init__()
        self.ae = UNet(in_channels=64, out_channels=64)
