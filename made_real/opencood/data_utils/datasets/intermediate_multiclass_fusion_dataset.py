...
def getIntermediatemulticlassFusionDataset(cls):
    ...
    class IntermediatemulticlassFusionDataset(cls):
        ...
        def get_item_single_car(self, selected_cav_base, ego_cav_base, tpe='all'):
            """
        ...
        def __getitem__(self, idx, extra_source=None):
            ...
            output_dict = {}
            for tpe in ['all', 0, 1, 3]:  # , 0, 1, 3
                output_single_class = self.__getitem_single_class__(idx, tpe, extra_source)
        ...
        def __getitem_single_class__(self, idx, tpe=None, extra_source=None):
